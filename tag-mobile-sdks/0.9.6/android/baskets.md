...
permalink: /tag-mobile-sdks/0.9.6/android/baskets/
---
...
Once you have created an invoice for a basket you can make a [Payment]({{site.baseurl}}/tag-mobile-sdks/0.9.6/android/payments/) for that invoice.
