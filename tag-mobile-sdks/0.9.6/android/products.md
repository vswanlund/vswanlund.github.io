...
permalink: /tag-mobile-sdks/0.9.6/android/products/
---
...
To explore this topic in detail, [import the HelloPowaTagSample]({{site.baseurl}}/tag-mobile-sdks/0.9.6/android/start/#importing-the-sample-app) app and review the <code>ProductDetailsActivity</code> class.
...
Add a variant to the users [Baskets]({{site.baseurl}}/tag-mobile-sdks/0.9.6/android/baskets/) then check out to to get shipping and taxes.
