...
permalink: /tag-mobile-sdks/0.9.6/ios/baskets/
---
...
1. Once you have created an invoice for a basket you can make a [Payment]({{site.baseurl}}/tag-mobile-sdks/0.9.6/ios/payments/) for that invoice.
