...
permalink: /tag-mobile-sdks/0.9.7/wp/login/
---
...
1. Use the <code>LoginManager</code> to [create a temporary profile]({{site.baseurl}}/tag-mobile-sdks/0.9.7/wp/login#log-in-and-create-a-temporary-profile).
2. Use the <code>ProfileManager</code> to [update profile details]({{site.baseurl}}/tag-mobile-sdks/0.9.7/wp/profile#updating-the-profile). E.g Email and Mobile number. (An optional step that can be done later)
3. Use the <code>ProfileManager</code> to [save the temporary profile]({{site.baseurl}}/tag-mobile-sdks/0.9.7/wp/profile#saving-the-profile).
4. Use the <code>LoginManager</code> to [log into the profile]({{site.baseurl}}/tag-mobile-sdks/0.9.7/wp/login#log-into-an-existing-powatag-profile) using the profile ID, Email or Mobile number.
...
Once logged in you can retrieve the [Profile]({{site.baseurl}}/tag-mobile-sdks/0.9.7/wp/profile/) for the current user or get a [Workflow]({{site.baseurl}}/tag-mobile-sdks/0.9.7/wp/workflows/) when a [Trigger]({{site.baseurl}}/tag-mobile-sdks/0.9.7/wp/triggers/) detects a PowaTag.
...
To see detailed examples of three methods, [import the HelloPowaTagSample]({{site.baseurl}}/tag-mobile-sdks/0.9.7/wp/start/#importing-the-sample-app) app and review the <code>MainPageViewModel</code> class.
