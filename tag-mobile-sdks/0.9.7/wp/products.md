...
permalink: /tag-mobile-sdks/0.9.7/wp/products/
---
...
To explore this topic in detail, [import the HelloPowaTagSample]({{site.baseurl}}/tag-mobile-sdks/0.9.7/wp/start/#importing-the-sample-app) app and review the <code>ProductPageViewModel</code> class.
...
Add a variant to the users [Baskets]({{site.baseurl}}/tag-mobile-sdks/0.9.7/wp/baskets/) then check out to get shipping and taxes.
